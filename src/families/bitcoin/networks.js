...
export const getNetworkParameters = (
  ...
  if (networkName === "bitcoin") {
    return {
      ...
      dustAmount: BigNumber(546),
      messagePrefix: "Bitcoin signed message:\n",
      usesTimestampedTransaction: false,
      timestampDelay: BigNumber(0),
    ...
    return {
      ...
      xpubVersion: Buffer.from([0x04, 0x88, 0xb2, 0x1e]),
      feePolicy: BitcoinLikeFeePolicy.PER_BYTE,
      dustAmount: BigNumber(5430),
      messagePrefix: "Bitcoin signed Message:\n",
      usesTimestampedTransaction: false,
      timestampDelay: BigNumber(0),
      sigHash: Buffer.from([
        BitcoinLikeSigHashType.SIGHASH_ALL.readUInt8() |
          BitcoinLikeSigHashType.SIGHASH_FORKID.readUInt8(),
      ]),
      additionalBIPs: [],
    };
